...
def initSongs():
    ...
    Song24 = Song(name="Dance the Night- Barbie", url="", description=" Dua Lipa ", uri="https://upload.wikimedia.org/wikipedia/en/c/c7/Dua_Lipa_-_Dance_the_Night.png", tokens="24")
